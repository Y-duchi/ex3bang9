...
class ShoppingFavorite extends StatefulWidget {
  const ShoppingFavorite({Key? key}) : super(key: key);

  @override
  State<ShoppingFavorite> createState() => _ShoppingFavoriteState();
}

class _ShoppingFavoriteState extends State<ShoppingFavorite> {
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              await toggleFavorite(item['product_id'], isFavorited[index]);
                            },
                            child: Icon(
