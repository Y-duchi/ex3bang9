...
class SaleFurniturePage extends StatefulWidget {
  const SaleFurniturePage({super.key});

  @override
  State<SaleFurniturePage> createState() => _NewFurniturePageState();
}

class _NewFurniturePageState extends State<SaleFurniturePage> {
  List furnitureList = [];
  List<bool> likedList = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('세일 가구', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
